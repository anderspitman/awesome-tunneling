...
* [OpenZiti](https://openziti.github.io) - [![OpenZiti github stars badge](https://img.shields.io/github/stars/openziti/ziti?style=flat)](https://github.com/openziti/ziti/stargazers) - OpenZiti is a fully open source zero trust overlay network (licensed Apache v2). The goal of OpenZiti is to extend zero trust all the way into your application, not just to your network. Consisting a fully featured mesh network, mTLS between all nodes, e2e encryption of tunnels, continous posture checking, client agents to support brownfield applications (which also support truly *private* DNS), SDKs for many laguages (and C SDK for FFI). It's a fully-featured tunneling solution.
