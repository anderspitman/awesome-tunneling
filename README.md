...
* [zrok](https://zrok.io/) [![zrok github stars badge](https://img.shields.io/github/stars/openziti/zrok?style=flat)](https://github.com/openziti/zrok/stargazers) - Allows effortless sharing of files publicly **and** privately. Built on OpenZiti, an open source, zero trust, overlay network. 
