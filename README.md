...
* [Punchmole](https://github.com/Degola/punchmole/) - Open source slim and only self-hostable. Simple and straight-forward configuration to use, customise and deploy quickly also as part of a Node project 
...
* [gt](https://github.com/ao-space/gt)[![frp github stars badge](https://img.shields.io/github/stars/ao-space/gt?style=flat)](https://github.com/ao-space/gt/stargazers) - GT is an open source reverse proxy project that supports peer-to-peer direct connection (P2P) and Internet relay.
