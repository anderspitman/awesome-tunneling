...
* [boundary](https://github.com/hashicorp/boundary) [![boundary github stars badge](https://img.shields.io/github/stars/hashicorp/boundary?style=flat)](https://github.com/hashicorp/boundary/stargazers) - An alternative to Teleport from well known open source company Hashicorp. Provides a control plane where users can login via ID provider (like github) and establish connections to the target servers routed over the control instance. New sessions are (currently) always setup via CLI client. 
