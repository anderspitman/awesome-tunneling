...
* [frp-operator](https://github.com/zufardhiyaulhaq/ngrok-operator) - Open source FRP solution on top of  Kubernetes, allows developers on private kubernetes to easily access their services via FRP.
